...
/**
 * Se aplica una implementación que consiste de una cola con prioridad basada en un heap  usando un Vector.
 * Esto permite que se mantengan los elementos ordenados por prioridad
 * prioridad (según el orden natural de Comparable)
 *
...
public class VectorHeap<E extends Comparable<E>> {
    ...
    /**
     * Se crea VectorHeap a partir de un vector existente.
     *
     * @param v
     */
    ...
    /**
     * Se encarga del devolver el índice del padre del nodo en la posición especificada.
     *
